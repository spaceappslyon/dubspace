...
public class Sun_Bell extends PApplet {
...
myX = PApplet.parseInt(radius*sin(angleA)*cos(angleB));
myY = PApplet.parseInt(radius*sin(angleA)*sin(angleB));
myZ = PApplet.parseInt(radius*cos(angleA));
...
z = myZ; 
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Sun_Bell" };
    if (passedArgs != null) {
